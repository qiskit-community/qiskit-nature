...
"""The Particle Operator base interface."""
...
class ParticleOperator(ABC):
    ...
    def register_length(self) -> int:
        """Getter for the length of the particle register that the ParticleOperator acts on."""
        raise NotImplementedError

    @property
    @abstractmethod
    def operator_list(self) -> List[Any]:
        """Getter for the operator_list of the `ParticleOperator`"""
        raise NotImplementedError
