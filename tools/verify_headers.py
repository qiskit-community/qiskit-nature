...
def _main():
    default_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "qiskit_nature"
    )
    ...
    parser.add_argument(
        ...
        help="Paths to scan by default uses ../qiskit_nature from the script",
    )
    args = parser.parse_args()
    files = discover_files(args.paths, exclude_folders=["gauopen"])
