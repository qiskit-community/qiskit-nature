...
class TestExcitationGenerator(QiskitNatureTestCase):
    ...
    @data(
        ...
        (2, 4, [1, 1], [((0, 2), (1, 3))]),
        (2, 4, [2, 2], []),
        (2, 6, [1, 1], [((0, 3), (1, 4)), ((0, 3), (1, 5)), ((0, 3), (2, 4)), ((0, 3), (2, 5))]),
        (2, 6, [2, 2], [((0, 3), (2, 5)), ((0, 4), (2, 5)), ((1, 3), (2, 5)), ((1, 4), (2, 5))]),
        (2, 6, [3, 3], []),
        (2, 8, [2, 2], [((0, 1), (2, 3)), ((0, 4), (2, 6)), ((0, 4), (2, 7)), ((0, 5), (2, 6)),
                        ((0, 5), (2, 7)), ((0, 4), (3, 6)), ((0, 4), (3, 7)), ((0, 5), (3, 6)),
                        ((0, 5), (3, 7)), ((1, 4), (2, 6)), ((1, 4), (2, 7)), ((1, 5), (2, 6)),
                        ((1, 5), (2, 7)), ((1, 4), (3, 6)), ((1, 4), (3, 7)), ((1, 5), (3, 6)),
                        ((1, 5), (3, 7)), ((4, 5), (6, 7))]),
    ...
    @data(
        ...
        (2, 6, [1, 1], 1, [((0, 3), (1, 4)), ((0, 3), (1, 5)), ((0, 3), (2, 4)), ((0, 3), (2, 5))]),
        (2, 8, [2, 2], 1, [((0, 4), (2, 6)), ((0, 4), (2, 7)), ((0, 5), (2, 6)), ((0, 5), (2, 7)),
                           ((0, 4), (3, 6)), ((0, 4), (3, 7)), ((0, 5), (3, 6)), ((0, 5), (3, 7)),
                           ((1, 4), (2, 6)), ((1, 4), (2, 7)), ((1, 5), (2, 6)), ((1, 5), (2, 7)),
                           ((1, 4), (3, 6)), ((1, 4), (3, 7)), ((1, 5), (3, 6)), ((1, 5), (3, 7))]),
    )
