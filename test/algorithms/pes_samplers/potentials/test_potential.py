...
from qiskit_nature.algorithms.pes_samplers.potentials.morse_potential import (
    MorsePotential,
)
...
class TestPotential(QiskitNatureTestCase):
    ...
    def create_test_molecule():
        ...
        m = Molecule(
            geometry=[["H", [0.0, 0.0, 0.0]], ["D", [0.0, 0.0, 1.0]]],
