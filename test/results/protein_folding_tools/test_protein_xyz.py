...
class TestProteinXYZ(QiskitNatureTestCase):
    ...
    def test_main_positions(self):
        ...
        self.assertTrue( np.allclose( self.test_xyz_1.main_positions,
                                      np.array([[ 0.        ,  0.        ,  0.        ],
        ...
        self.assertTrue( np.allclose( self.test_xyz_2.main_positions,
                                      np.array([[ 0.        ,  0.        ,  0.        ],
                                                [ 0.57735027,  0.57735027, -0.57735027],
                                                [ 1.15470054,  0.        , -1.15470054],
                                                [ 1.73205081, -0.57735027, -0.57735027],
    ...
    def test_xyz_file(self):
        ...
        self.assertTrue( (self.test_xyz_1.get_xyz_file("", False) ==
                                     np.array([['A', '0.0', '0.0', '0.0'],
                                               ...
                                               ['F', '1.7320508075688776', '0.5773502691896258',
                                                '0.5773502691896258'],
                                               ['Y', '1.154700538379252', '1.1547005383792517', '0.0']],
                                              dtype='<U32')).all())
                                     
        self.assertTrue( (self.test_xyz_2.get_xyz_file("", False) ==
                          np.array([['A', '0.0', '0.0', '0.0'],
                                 ['P', '0.5773502691896258', '0.5773502691896258',
                                  '-0.5773502691896258'],
                                 ['R', '1.1547005383792517', '0.0', '-1.1547005383792517'],
                                 ['L', '1.7320508075688776', '-0.5773502691896258',
                                  '-0.5773502691896258'],
                                 ['R', '2.3094010767585034', '0.0', '0.0'],
                                 ['F', '0.5773502691896258', '0.5773502691896258',
                                  '-1.7320508075688776'],
