...
* The [Gaussian 16 driver](qiskit/chemistry/drivers/second_quantization/gaussiand) in `qiskit.chemistry`
  contains [work](qiskit/chemistry/drivers/second_quantization/gaussiand/gauopen) licensed under the
  [Gaussian Open-Source Public License](qiskit/chemistry/drivers/second_quantization/gaussiand/gauopen/LICENSE.txt).
