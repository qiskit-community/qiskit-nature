...
def create_labels(boson_hamilt_harm_basis: List[List[Tuple[List[List[int]], float]]],
                  truncation_order: int) -> List[Tuple[str, float]]:
...
def _create_num_body_labels(num_body_data: List[Tuple[List[List[int]], float]]) -> \
