...
class VSCFInitialPoint(InitialPoint):
    ...
    that will correspond to the VSCF initial point once the
    :class:`~qiskit.circuit.library.VSCFInitialState` circuit is prepended to the
    :class:`~qiskit.circuit.library.UVCC` circuit.
    The excitation list generated by the :class:`~qiskit.circuit.library.UVCC` ansatz is obtained to
