...
class MolecularGroundStateEnergy:
    ...
    def __init__(self,
        ...
        Args:
            ...
            z2symmetry_reduction: If z2 symmetry reduction should be applied to the qubit operators
                ...
                See also :class:`~qiskit_nature.core.Hamiltonian` which has the core
    ...
    def compute_energy(self,
        ...
        Raises:
            QiskitNatureError: If no MinimumEigensolver was given and no callback is being
                                  used that could supply one instead.
        """
        if self.solver is None and callback is None:
            raise QiskitNatureError('MinimumEigensolver was not provided')
        ...
        return core.process_algorithm_result(raw_result)  # type: ignore
