...
def parse(fcidump: str) -> Dict[str, Any]:
        ...
        if i == a == j == b == 0:
            ...
            try:
                ...
                if _uhf:
                    ...
                    raise QiskitNatureError("Unkown 1-electron integral indices encountered in \
                            '{}'".format((i, a))) from ex
        else:
            try:
                ...
                if _uhf:
                    ...
                    raise QiskitNatureError("Unkown 2-electron integral indices encountered in \
    ...
    if _uhf:
        ...
        if np.allclose(hijkl_ab, 0.0) == np.allclose(hijkl_ba, 0.0):
            raise QiskitNatureError("Encountered mixed sets of indices for the 2-electron \
