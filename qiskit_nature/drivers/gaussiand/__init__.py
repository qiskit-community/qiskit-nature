...
<https://github.com/Qiskit/qiskit-nature/blob/main/qiskit_nature/drivers/gaussiand/gauopen/LICENSE.txt>`_.
...
`qiskit_nature/drivers/gaussiand/gauopen` directory inside the Qiskit
