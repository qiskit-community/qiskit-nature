...
class VibrationalStructure1DFD(VibrationalStructureBase):
    ...
    def __init__(self, molecule, energy_surface, *, num_intervals=10000):
        """
        Constructor.
    ...
    def initialize(self):
        ...
        bound_left = bounds[0] - self.energy_surface.get_equilibrium_geometry()
        bound_right = bounds[1] - self.energy_surface.get_equilibrium_geometry()
    ...
    def get_centered_potential(pot):
        ...
        """
        return lambda x: (pot.eval(x + pot.get_equilibrium_geometry()) - pot.get_minimal_energy())

    @staticmethod
    def find_bounds(centered_pot, *, max_val=500, min_x=-10, max_x=10):
        """
